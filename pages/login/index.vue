  ...
  <div class="lg:flex">
    ...
    <div class="hidden lg:flex items-center justify-center bg-indigo-100 flex-1 h-screen">
      <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
        <svg id="f080dbb7-9b2b-439b-a118-60b91c514f72" class="w-5/6 mx-auto" data-name="Layer 1"
             viewBox="0 0 528.71721 699.76785" xmlns="http://www.w3.org/2000/svg">
          <title>Login</title>
          <rect fill="#535461" height="657" width="444" y="17.06342"/>
          <polygon fill="#7f9cf5" points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063"/>
          <circle cx="296" cy="377.06342" fill="#535461" r="4"/>
          <polygon
              fill="#535461"
              points="296 377.66 298.773 382.463 301.545 387.265 296 387.265 290.455 387.265 293.227 382.463 296 377.66"/>
          <polygon fill="#7f9cf5" points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063"/>
          <g opacity="0.1">
            <polygon fill="#fff" points="337.217 691 317.217 691 318.217 0 337.217 0 337.217 691"/>
          </g>
          <circle cx="296" cy="348.06342" opacity="0.1" r="13"/>
          <circle cx="296" cy="346.06342" fill="#535461" r="13"/>
          <line fill="none" opacity="0.1" stroke="#000" stroke-miterlimit="10" stroke-width="2" x1="52.81943"
                x2="52.81943" y1="16.10799" y2="677.15616"/>
          <line fill="none" opacity="0.1" stroke="#000" stroke-miterlimit="10" stroke-width="2" x1="109.81943"
                x2="109.81943" y1="12.10799" y2="679.15616"/>
          <line fill="none" opacity="0.1" stroke="#000" stroke-miterlimit="10" stroke-width="2" x1="166.81943"
                x2="166.81943"
                y1="9.10799" y2="683"/>
          <line fill="none" opacity="0.1" stroke="#000" stroke-miterlimit="10" stroke-width="2" x1="223.81943"
                x2="223.81943" y1="6.10799" y2="687.15616"/>
          <line fill="none" opacity="0.1" stroke="#000" stroke-miterlimit="10" stroke-width="2" x1="280.81943"
                x2="280.81943"
                y1="3.10799" y2="688"/>
          <ellipse cx="463.21721" cy="95.32341" fill="#2f2e41" rx="39.5" ry="37"/>
          <path d="M683.8586,425.93948l-10,14s-48,10-30,25,44-14,44-14l14-18Z"
                fill="#ffb8b8" transform="translate(-335.6414 -100.11607)"/>
          <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z"
                fill="#7f9cf5" transform="translate(-335.6414 -100.11607)"/>
          <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z"
                opacity="0.1" transform="translate(-335.6414 -100.11607)"/>
          ...
          <path
              ...
              fill="#2f2e41" transform="translate(-335.6414 -100.11607)"/>
          ...
          <path
              ...
              fill="#2f2e41" transform="translate(-335.6414 -100.11607)"/>
          <circle cx="465.21721" cy="105.82341" fill="#ffb8b8" r="34"/>
          <path
