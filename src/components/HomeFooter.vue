      ...
      <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
        ...
        >
          <span class="flex items-start sm:items-center">
            <img alt="" class="w-auto h-6 text-gray-800 fill-current" src="https://i.imgur.com/MDYUATR.webp">
          </span>
        </router-link>
        <p class="mt-6 mr-4 text-base text-gray-500">
          Crafting the next-level of magic experience and engagement.
        </p>
      </div>
      <div class="block pl-10 mt-6 text-sm sm:flex lg:mt-0">
...
const copyrightMsg = '© 2022 Peperuto Shop. All rights reserved.'
</script>
